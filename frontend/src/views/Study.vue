...
<main  class="flex align-center justify-center flex-col " style="border: 1px solid green">
    <Navbar :maintitle=maintitle>
        <template class="quicktools">
            ...
            <div id="toolbar">
                <font-awesome-icon class="quicktoolsicons" icon="fa-solid fa-magnifying-glass" size="xl" style="color: #6c6f65;"/>
                <font-awesome-icon class="quicktoolsicons" icon="fa-solid fa-arrows-to-circle" size="xl" style="color: #6c6f65;"/>
                <font-awesome-icon class="quicktoolsicons" icon="fa-solid fa-highlighter" size="xl" style="color: #6c6f65;"/>
                <font-awesome-icon class="quicktoolsicons" icon="fa-solid fa-house" size="xl" style="color: #6c6f65;"/>
            </div>
        </template>
    </Navbar>
